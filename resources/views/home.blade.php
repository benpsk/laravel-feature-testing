            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <nav class="-mx-3 flex flex-1 justify-end">
                        @auth
                        <a href="{{ url('/posts') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            My Post
                        </a>
                        @else
                ...
                <main class="mt-6">
                    <div class="bg-white py-6 sm:py-8 lg:py-12 rounded-md">
                            ...
                            <div class="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-2 xl:grid-cols-2 xl:gap-16 mb-4">
                                ...
                                <div class="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <span class="text-sm text-gray-400"> {{ $post->created_at->format('F d, Y') }} </span>
