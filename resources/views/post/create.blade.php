            ...
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <form method="post" action="{{ route('posts.store') }}" class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('email')" autofocus />
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="body" id="body" class="h-64 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
                    </div>
