...
class PostTest extends TestCase
{
    ...
    public function test_update_post_validation(array $invalidData, string $errorField)
    {
        $post = Post::factory()->create(['user_id' => $this->user->id]);
    ...
    #[DataProvider('invalidPostDataProvider')]
    public function test_store_post_validation(array $invalidData, string $errorField)
    {
